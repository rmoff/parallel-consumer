...
There is also a active fork of the project maintained by one of the original creators, https://github.com/astubbs[@astubbs]: https://github.com/astubbs/parallel-consumer.
====
